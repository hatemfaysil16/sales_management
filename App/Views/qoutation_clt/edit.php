			...
			<form method="post" action="" enctype="multipart/form-data" id="form-add">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
                        <?php if (isset($qoutation_clt)) { ?>
						<input type="hidden" name="client_id_info" value="<?= $qoutation_clt->id ?>" class="client_id_info">

						<h3 class="client_name_info"><?= $qoutation_clt->client_name ?></h3>
						<p class="client_adress_info"><?= $qoutation_clt->city ?></p>
						<p class="client_city_info"><?= $qoutation_clt->adress ?></p>
                        <?php } else { ?>
